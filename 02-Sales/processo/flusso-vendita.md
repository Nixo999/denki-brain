...
**Script**: [[script-siti-vetrina]] — anche in Word, per Giulia.
...
**Script**: [[script-ecommerce]] — anche in Word, per Giulia.
...
**Script**: [[script-denkishift]] + [[pattern-interrupt]] — anche in Word.
...
**Script**: [[script-indagine]] — anche in Word, per Giulia.
