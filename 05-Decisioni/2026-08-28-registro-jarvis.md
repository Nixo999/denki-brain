...
sta in un file solo — [[registro-jarvis]] — e **ogni** comando del vault lo
...
Su sua richiesta — «rendilo specificamente simile a quello di JARVIS» e «come se
...
- Il registro si cambia **in un punto solo**. Chi modifica un comando non ci
  riscrive dentro il tono: aggiunge a [[registro-jarvis]].
...
[[registro-jarvis]] · [[stile-comunicazione]] · [[2026-08-28-push-automatico]]
