...
| 13:3x | Nicola +claude | [[denkishift]] | `smooth-duty` | ✅ sviluppo: `20-pagina-disponibilita.sql` eseguita (20/20) · ⬜ **PRODUZIONE: da eseguire prima del push** | Pagina Disponibilità spegnibile dalle Impostazioni; Supervisione senza assenti. Committato locale, push in attesa della migrazione | locale |
